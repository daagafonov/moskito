	...
	<div class="white_pl">
		<div class="top">
			<div class="left_bg"><!-- --></div>
				...
				<ul>
                    <ano:equal name="currentNaviItem" value="DASHBOARD">
                        <li class="active"><a href="mskDashBoard">Dashboard</a></li>
                    </ano:equal>
                    <ano:notEqual name="currentNaviItem" value="DASHBOARD">
                        <li><a href="mskDashBoard">Dashboard</a></li>
                    </ano:notEqual>
